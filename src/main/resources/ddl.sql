...
create table produto (id bigint not null auto_increment, ativo bit, descricao varchar(255), nome varchar(255) not null, preco decimal(19,2), restaurante_id bigint, primary key (id)) engine=InnoDB
